        ...
        <div className="fixed top-0 text-white bg-dot-texture bg-body">
            <div className="fixed left-0 right-0 top-2 mx-auto bg-black font-[Lexend] justify-between search-bar flex rounded-2xl h-10 w-5/6 max-w-[728px] text-white">
                ...
                <input
                    ...
                    className=" bg-black rounded-2xl px-3 w-full"
                    type="text"
                />
            </div>
            {/* <div className="flex flex-col mt-16 max-w-[728px] px-5 mx-auto">
                <ChatCard />
                <ChatCard />
                <ChatCard />
                <ChatCard />
            ...
            <div className="relative flex h-screen w-screen items-center justify-center">
                ...
                <div className="font-[Lexend] tracking-wider absolute top-[460px] text-gray-400">
                    You don't have any chats to display
                </div>
            </div>
        </div>
    );
