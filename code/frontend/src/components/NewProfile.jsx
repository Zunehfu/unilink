                    ...
                    <div className="min-h-[70%] relative rounded-t-[60px] bg-dark flex flex-col">
                        ...
                        <div className="py-1 flex justify-around items-center">
                            <div className="text-center">
                                <b className="number">{values.pal_count}</b>
                                <br />
                                Friends
                            </div>
                            <div className="text-center">
                                <b className="number">{values.post_count}</b>
                                <br />
                                Posts
                            </div>
                        </div>
                        ...
                        <div className="py-2 text-center">{values.name}</div>
                        ...
                        {at === 0 && <AdditionalInfo values={values} />}
                        {at === 1 && <PhotosLayout />}
                        {at === 2 && <ShoutsList />}
                        {at === 3 && <MutualList />}
                    </div>
