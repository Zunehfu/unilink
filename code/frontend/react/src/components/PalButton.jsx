        ...
        <>
            {activeProfileData.pal_status == 0 && (
                <button
                    ...
                    className="shadow-md bg-gradient-to-tr  from-indigo-500 via-20% via-sky-500 to-emerald-500  py-1 px-5 absolute right-1/3 rounded-full"
                >
                    Be Pals
                </button>
            )}
            {activeProfileData.pal_status == 1 && (
                <button
                    onClick={handleUnpal}
                    className="shdaow-md bg-gradient-to-tr  from-indigo-500 via-20% via-sky-500 to-emerald-500  py-1 px-5 absolute right-1/3 rounded-full"
                >
                    Unpal
                </button>
            )}
            {activeProfileData.pal_status == 2 && (
                <div className="absolute right-1/3 ">
                    <button
                        ...
                        className="shdaow-md bg-gradient-to-tr from-indigo-500 via-20% via-sky-500 to-emerald-500  py-1 px-5  rounded-l-full"
                    >
                        Accept
                    </button>
                    <button
                        onClick={handleRejectPalProposal}
                        className="shdaow-md bg-black text-red-500 font-sans font-semibold py-1 px-5 rounded-r-full"
                    >
                        X
                    </button>
                </div>
