...
export default function Comments({
    ...
    return (
        <>
            <div className="shadow-md flex rounded-[22px] relative mt-3.5 py-2.5 bg-offwhite">
                <div className=" absolute flex justify-center w-full -top-[43px]">
                    <span className="h-[22px] border-[22px] border-transparent border-b-offwhite"></span>
                </div>
                <div className="px-2.5 max-h-96 w-96 flex flex-col gap-2.5 overflow-y-scroll transition-all">
                    {comments.map((item) => (
